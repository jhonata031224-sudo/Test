...
export const loginOwner = async (email, pass) => {
    ...
    try {
        ...
        setTimeout(() => location.href = 'dashboard-owner.html', 1500);
    } catch (e) {
...
export const loginStaff = async (email, pass) => {
    try {
        ...
        setTimeout(() => location.href = 'dashboard-staff.html', 1500);
    } catch (e) {
        checkAttempts('staff');
...
export const loginPelanggan = async (username, pass) => {
    ...
    try {
        ...
        setTimeout(() => location.href = 'dashboard-customer.html', 1500);
    } catch (e) {
