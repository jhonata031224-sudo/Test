...
import { 
    getFirestore, doc, updateDoc, onSnapshot, collection, setDoc, getDoc, addDoc, deleteDoc, query, orderBy 
...
export const handleLogout = async (targetUrl = 'login-pelanggan.html') => {
...
window.handleRegisterPelanggan = async () => {
    ...
    try {
        ...
        setTimeout(() => window.location.href = 'login-pelanggan.html', 1800);
...
window.handleRegisterStaff = async () => {
    ...
    try {
        ...
        setTimeout(() => window.location.href = 'login-staff.html', 1800);
...
export { auth, db, collection, onSnapshot, query, orderBy, updateDoc, doc, setDoc, addDoc, deleteDoc };